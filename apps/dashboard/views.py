...
from apps.dashboard.resources import TransactionResource
...
def list_transactions(request, category: str):
    ...
    return render(request,
                  'dashboard/list_transactions.html', context)
...
def detail_transaction(request, pk: int):
    ...
    return render(request,
                  'transaction/detail_transaction.html', context)
...
def delete_transaction(request, pk: int):
    ...
    return render(request,
                  'transaction/delete_transaction.html', context)
