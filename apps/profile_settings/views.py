...
def page_update_category(request, pk):
    ...
    return render(request,
                  'category/page_update_category.html', context)
...
def update_subcategory(request, pk):
    ...
    context = {'form': form,
               ...
               'category': category}
    return render(request,
                  'subcategory/update_subcategory.html', context)
...
def delete_subcategory(request, pk):
    ...
    return render(request,
                  'subcategory/delete_subcategory.html', context)
...
def form_subcategory(request):
    ...
    context = {'form': form}
    return render(request,
                  'subcategory/form_subcategory.html', context)
